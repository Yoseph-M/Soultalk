    ...
    return (
        <div className={`flex h-screen overflow-hidden ${isDark ? 'bg-[#0f172a] text-slate-200' : 'bg-slate-50 text-slate-900'}`}>
            ...
            < div className="flex-1 flex flex-col h-full relative min-w-0" >
                ...
                < header className={`px-4 py-3 flex items-center justify-between border-b backdrop-blur-md sticky top-0 z-20 ${isDark ? 'bg-[#0f172a]/90 border-slate-800' : 'bg-white/90 border-slate-200'
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex items-center gap-2">
                            <div className={`w-8 h-8 rounded-full flex items-center justify-center shadow-lg ${isDark ? 'bg-[#00407A] shadow-[#00407A]/20' : 'bg-[#2196F3] shadow-[#2196F3]/20'}`}>
                                <Bot className="w-5 h-5 text-white" />
                            </div>
                            <h1 className="font-bold text-sm md:text-base leading-tight">SoulTalk AI</h1>
                        </div>
                    </div>
                ...
                < main className="flex-1 overflow-y-auto px-4 py-6 md:px-6 custom-scrollbar scroll-smooth flex flex-col" >
